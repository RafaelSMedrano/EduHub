...
$this->pageTitle = 'EduHub PrivacyPolicy';
?>
...
<body>
  ...
  <p>This privacy policy applies to the EduHub app (hereby referred to as "Application") for mobile devices that was created by Rafael Medrano (hereby referred to as "Service Provider") as a Freemium service. This service is intended for use "AS IS".</p>
  ...
  <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to Name, Email address, User IDs, Photos, Videos, Voice or sound recordings, Files and documents, Device identifiers and others. The information that the Service Provider request will be retained by them and used as described in this privacy policy.</p>
  ...
  <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at eduhub@eduhub.com.br and they will respond in a reasonable time.</p>
  ...
  <p>This privacy policy is effective as of 2024-04-12</p>
  ...
  <p>If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at eduhub@eduhub.com.br.</p>
